package br.com.bieniek.sbootlocalstack.s3.service.impl;
...
public class S3FileServiceImpl implements S3FileService {
    ...
    // The ResourceLoader interface is the central interface in Spring for loading resources. It provides an abstraction for accessing different types of resources in a uniform manner.
    private final ResourceLoader resourceLoader;

    // The ResourcePatternResolver interface extends the ResourceLoader interface, adding the ability to resolve resource patterns into Resource arrays.
