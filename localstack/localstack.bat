...
aws --endpoint http://localhost:4566 --profile localstack ssm put-parameter --name "/config/sboot-localstack_localstack/s3Bucket" --value "s3-helloworld" --type String
aws --endpoint http://localhost:4566 --profile localstack ssm put-parameter --name "/config/sboot-localstack_localstack/dbUrl" --value "jdbc:mysql://localhost:3306/databasedemo?createDatabaseIfNotExist=true" --type String
aws --endpoint http://localhost:4566 --profile localstack ssm put-parameter --name "/config/sboot-localstack_localstack/dbUser" --value "admin" --type String
aws --endpoint http://localhost:4566 --profile localstack ssm put-parameter --name "/config/sboot-localstack_localstack/dbPass" --value "admin123456789" --type String
